            ...
            <div className="container mx-auto px-4">
                ...
                <section className="mb-16 text-center">
                    ...
                    <p className="text-xl max-w-3xl mx-auto">
                        At WebWeavers, we're not just developers — we're digital craftsmen. With a passion for clean code and a focus on real business impact.
                    </p>
                </section>
                ...
                <section className="mb-16">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        <div>
                            <p className="mb-4">
                                Founded in 2023, WebWeavers began with a simple mission: to help local businesses establish a professional online presence without the technical headaches.
                            </p>
                            <p className="mb-4">
